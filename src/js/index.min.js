$(document).ready(function () {
    ...
    function checkSomeChanges() {
        ...
        else if(monograme != '') if(monograme != $('#monograme').val()) $('.thumbail-preview').css('display', "none"); monograme = '';     
    }
    ...
    $(document).keypress(function (e) {
        ...
        if ($('#monograme').is(':focus')) monograme = 'Some' // prevent Enter to execute click when you are in textarea input
