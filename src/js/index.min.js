$(document).ready(function () {
                ...
                if ($('.font').val().length) {
                    if ($('#position').val().length) {
                        if ($('#color').val().length) {
                            ...
                            $.ajax({
                                url: 'https://node.formens.ro/broidery_order?m=' + monograme + '&f=' + $('.font').val() + '&c=' + $('#color').val(),
                                type: 'GET',
                                success: function (data) {
                                    ...
                                    if (response) {
                                        ...
                                        font = $('.font').val();
                                        color = $('#color').val();
                                        monograme = $('#monograme').val();
                                        console.log("TX font value from response ", font, color, monograme);
    ...
    // If are changes on monograme, font or color, image disappear
    function checkSomeChanges() {
        ...
        else if(monograme != '') if(monograme != $('#monograme').val()) $('.thumbail-preview').css('display', "none");    
    }
    ...
    $(document).keypress(function (e) {
        ...
        if ($('#monograme').is(':focus')) checkSomeChanges(); // prevent Enter to execute click when you are in textarea input
